...
if __name__ == "__main__":
    ...
    # Example 1: Business context with deuteranopia
    print("\n📋 Example 1: Business Outfit Recommendation")
    
    context = RecommendationContext(
        fashion_style=FashionContext.BUSINESS,
    ...
    primary_colors = ["#2C3E50", "#FFFFFF"]  # Navy and white
    ...
    # Example 2: Creative evening look
    print("\n📋 Example 2: Creative Evening Look")
    
    context = RecommendationContext(
        fashion_style=FashionContext.CREATIVE,
        season=Season.SUMMER,
        occasion=Occasion.PARTY,
        time_of_day="evening",
        preferred_saturation="high",
        avoid_colors=["#000000", "#808080"]  # Avoid black and gray
    )
    
    primary_colors = ["#FF69B4","#1E90FF"]  # Hot pink and dodger blue
